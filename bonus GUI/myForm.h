...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Click += gcnew System::EventHandler(this, &myForm::FetchButton_Click);
			// 
			// button6
			// 
			this->button6 = (gcnew System::Windows::Forms::Button());
			...
			this->ClearCemoryButton->Click += gcnew System::EventHandler(this, &myForm::ClearMemoryButton_Click);
			...
			this->LoadDataButton->Click += gcnew System::EventHandler(this, &myForm::LoadDataButton_Click);
			...
			this->StepBack->Click += gcnew System::EventHandler(this, &myForm::StepBackButton_Click);
			// 
			// Run
			// 
			...
			this->SingleStepButton->Click += gcnew System::EventHandler(this, &myForm::SingleStepButton_Click);
			...
			this->HaltButton->Click += gcnew System::EventHandler(this, &myForm::HaltButton_Click);
			...
			label00->TextChanged += gcnew System::EventHandler(this, &myForm::textBox1_TextChanged);
	...
	private: System::Void myForm::textBox1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
